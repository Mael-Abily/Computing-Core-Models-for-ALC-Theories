...
\begin{itemize}
\item $F_{m+1}= \Appl(F_m,t_m),\ldots,F_k = \Appl(F_{k-1},t_{k-1})$, where $t_m,\ldots,t_{k-1}$ are oblivious triggers, have been obtained by a rule application,
